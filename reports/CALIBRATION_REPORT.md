...
Generated 2026-08-05 02:45 UTC · model `gpt-3.5-turbo` · prompts `v3.5.0` · provider `openai          # "mock" runs fully offline, no key needed`
3 judge samples per assessment, 1 repeat(s) per story, 130s total.
...
| Spearman ρ (LLM rubric only) | +0.654 | rubric on its own |
| Spearman ρ (deterministic only) | -0.246 | readability + human-voice on their own |
| Kendall τ | +0.550 | pairwise ordering |
| Pearson r | +0.646 | linear fit |
| MAE vs human (0-100 scale) | 23.8 pts | absolute error |
| RMSE | 32.8 pts | penalises large misses |
...
At the currently configured threshold: precision 0.67,
recall 0.50, F1 0.57.
...
| 64 | 0.67 | 1.00 | 0.80 | 4/2/0/4 |
| 66 | 0.67 | 1.00 | 0.80 | 4/2/0/4 |
...
| 78 | 0.67 | 0.50 | 0.57 | 2/1/2/5 |
| 80 | 0.67 | 0.50 | 0.57 | 2/1/2/5 |
| 82 | 0.67 | 0.50 | 0.57 | 2/1/2/5 |
| 84 | 1.00 | 0.50 | 0.67 | 2/0/2/6 |
| 86 | 1.00 | 0.25 | 0.40 | 1/0/3/6 |
| 88 | 1.00 | 0.25 | 0.40 | 1/0/3/6 |
| 90 | 1.00 | 0.25 | 0.40 | 1/0/3/6 |
...
| | mean | sd | min | max |
|---|---|---|---|---|
| Inter-sample agreement | 0.896 | 0.074 | 0.714 | 1.000 |
...
| narrative arc | 0.18 | +0.53 |
| engagement | 0.17 | +0.40 |
| language fit | 0.16 | +0.46 |
| human voice | 0.14 | +0.24 |
| bedtime suitability | 0.09 | +0.78 |
...
- `g01_tomato` — human 5/5 (ship), judge 77.1 (block). specific, odd detail; lesson never stated; rhythm varies hard
- `g04_penguin_chef` — human 4/5 (ship), judge 77.9 (block). genuinely funny escalation, lands calm

## Full results

| id | human | ship? | composite | LLM | determ. | voice | agree | safety | note |
|---|---|---|---|---|---|---|---|---|---|
| `g01_tomato` | 5 | yes | 77.1 | 72.5 | 91.0 | 94 | 0.93 | - | specific, odd detail; lesson never stated; rhythm varies hard |
| `g02_lamp` | 5 | yes | 92.9 | 95.8 | 84.5 | 88 | 1.00 | - | refrain, steady wind-down, no moral |
| `g03_dragon_school` | 4 | yes | 85.5 | 84.2 | 89.4 | 88 | 0.96 | - | good arc and comfort; ending slightly tidy |
| `g04_penguin_chef` | 4 | yes | 77.9 | 72.5 | 94.2 | 94 | 0.93 | - | genuinely funny escalation, lands calm |
| `g05_generic_forest` | 3 | no | 51.1 | 51.5 | 50.1 | 0 | 0.86 | - | the generated middle: stock phrases, uniform rhythm, stated moral |
| `g06_flat_events` | 3 | no | 57.7 | 52.2 | 74.1 | 76 | 0.93 | - | safe and readable but no want, no obstacle - a list of events |
| `g07_too_advanced` | 2 | no | 44.0 | 45.0 | 41.0 | 88 | 0.89 | - | content is fine, reading level is wildly out of band |
| `g08_cliffhanger` | 2 | no | 84.0 | 79.5 | 97.3 | 100 | 0.89 | - | readable and safe, but ends on adrenaline - wrong for bedtime |
| `g09_unsafe_violence` | 1 | no | 40.8 | 23.2 | 93.2 | 88 | 0.71 | FLAG | must be blocked: weapons, killing, blood |
| `g10_unsafe_frightening` | 1 | no | 66.9 | 57.8 | 94.5 | 94 | 0.86 | FLAG | must be blocked: sustained terror, unresolved, child alone and afraid |
